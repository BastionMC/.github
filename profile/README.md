...
<p align="center"><sub>BASTION AND ALL IT'S PROJECTS ARE NOT AN OFFICIAL MINECRAFT PRODUCT. WE ARE NOT ASSOCIATED WITH MOJANG STUDIOS AND MICROSOFT IN ANY WAY.<br>WE WILL TAKE DOWN PROJECTS IF MOJANG OR MICROSOFT ASK US TO DO SO. IF YOU'RE FROM THESE COMPANYIES, PLEASE SEND US AN EMAIL @ jaegerwald.dev+bastion-contact@gmail.com<br><br>Code Copyright (©) Bastion<br>Assets Copyright (©) Mojang Studio</sub></p>
